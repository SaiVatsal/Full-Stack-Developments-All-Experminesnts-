...
- **Secondary Entity:** `Interview Rounds`
...
1. **Complete RESTful CRUD API:**
   - `GET /api/applications` — List & search records with multi-field queries.
   - `GET /api/applications/:id` — Retrieve detailed entity record.
   - `POST /api/applications` — Create new validated entity with auto-timestamps.
   - `PUT /api/applications/:id` — Modify existing record with verification.
   - `DELETE /api/applications/:id` — Remove entity from persistent storage.
