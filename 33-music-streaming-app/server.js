/**
 * SoundWave Music Player & Catalog - Backend REST API Server
 * Domain: Media & Audio
...
app.get('/api/tracks/:id', (req, res) => {
  const db = readDb();
  const item = (db.tracks || []).find(i => String(i.id) === String(req.params.id));
  if (!item) {
...
app.delete('/api/tracks/:id', (req, res) => {
  ...
  res.json({ message: 'Audio Track deleted successfully', id: req.params.id });
});
...
if (require.main === module) {
  app.listen(PORT, () => {
    console.log('======================================================');
    console.log('🚀 SoundWave Music Player & Catalog is running!');
    console.log('📂 Category: Media & Audio');
