...
- **Secondary Entity:** `Team Standings`
...
1. **Complete RESTful CRUD API:**
   - `GET /api/fixtures` — List & search records with multi-field queries.
   - `GET /api/fixtures/:id` — Retrieve detailed entity record.
   - `POST /api/fixtures` — Create new validated entity with auto-timestamps.
   - `PUT /api/fixtures/:id` — Modify existing record with verification.
   - `DELETE /api/fixtures/:id` — Remove entity from persistent storage.
